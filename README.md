...
```bash
clone-gd-addon https://github.com/ChillCube/InteractableNode.git
```

## Documentation
You can find the documentation at: https://github.com/ChillCube/InteractableNode/blob/main/DOCUMENTATION.md

## Deinstallation
### Linux
Run this in the root of your godot project:
```bash
remove-gd-addon InteractableNode
```
...
- [DirectionalAnimatedSprite](https://github.com/ChillCube/DirectionalAnimatedSprite)
